...
if __name__ == "__main__":
    CONTROLER = "vel"
    scene_xml_path = os.path.join(utils.MODEL_ROOT, f"franka_emika_panda/scene_{CONTROLER}.xml")
    pin_xml_path = os.path.join(utils.MODEL_ROOT, f"franka_emika_panda/panda_{CONTROLER}.xml")
