...
def inverse_kinematics(current_q, target_dir, target_pos):
    ...
    import os
    urdf_filename = os.path.join(utils.MODEL_ROOT, 'franka_panda_description/robots/panda_arm.urdf')
    # 从 URDF 文件构建机器人模型
...
from mj_learning import utils
import os
model = mujoco.MjModel.from_xml_path(os.path.join(utils.MODEL_ROOT, 'franka_emika_panda/scene.xml'))
