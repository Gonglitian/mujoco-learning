...
if __name__ == "__main__":
    test = Test(os.path.join(utils.MODEL_ROOT, "trs_so_arm100/scene.xml"), 
                urdf_filepath=os.path.join(utils.MODEL_ROOT, "so_arm100_description/so100.urdf"), 
                models_folder=os.path.join(utils.MODEL_ROOT, "so_arm100_description"))
    test.run_loop()
