...
if __name__ == "__main__":
    SCENE_XML_PATH = os.path.join(utils.MODEL_ROOT, 'franka_emika_panda/scene_withtarget.xml')
    ARM_XML_PATH = os.path.join(utils.MODEL_ROOT, 'franka_emika_panda/panda.xml')
