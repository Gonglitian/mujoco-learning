...
from mj_learning.control.so100_real_control import ZMQCommunicator
...
SCENE_XML_PATH = os.path.join(utils.MODEL_ROOT, 'trs_so_arm100/scene.xml')
ARM_XML_PATH = os.path.join(utils.MODEL_ROOT, 'trs_so_arm100/so_arm100.xml')
