...
class Test(mujoco_viewer.CustomViewer):
    ...
    def runBefor(self):
        robot = pinocchio.buildModelFromUrdf(os.path.join(utils.MODEL_ROOT, 'panda_description/urdf/panda.urdf'))
...
test = Test(os.path.join(utils.MODEL_ROOT, "franka_emika_panda/scene.xml"))
test.run_loop()